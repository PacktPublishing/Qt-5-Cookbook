   ...
   : IUIController(parent)
{
   ...
   // We will move the following two sentences to a plugin in next recipe
   addMenuItem("&Edit", new QAction {QIcon {":/icons/configure.svg"}, "&Configure"});
   addToolButton("main-toolbar", new QAction {QIcon {":/icons/configure.svg"}, "&Configure"});
}
